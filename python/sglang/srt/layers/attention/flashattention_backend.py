...
class FlashAttentionBackend(AttentionBackend):
    ...
    def forward_extend(
        ...
        if layer.layer_id == 0:
            print("Extend Topk args: batch_size {}, sparse_bs_list {}, old_bs_to_new_bs_range {}, sparse_page_table shape {}, page_table shape {}".format(
                bs, sparse_bs_list, old_bs_to_new_bs_range, sparse_page_table.shape, page_table.shape
            ))
        ...
        if layer.layer_id == 0:
            print("Extend Flash-Attn args: sparse_page_table shape {}, sparse_cache_lens {}, sparse_cu_seqlens_q {}, sparse_cu_seqlens_k {}".format(
                sparse_page_table.shape, sparse_cache_lens, sparse_cu_seqlens_q, sparse_cu_seqlens_k
            ))
        ...
        if layer.layer_id == 0 and q.shape[0] == 8207:
