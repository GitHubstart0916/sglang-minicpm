...
class ModelRunner:
    ...
    def forward_decode(
        ...
        print("forward_decode ", forward_batch.input_ids, forward_batch.out_cache_loc)
    ...
    def forward_extend(
        ...
        print("forward_extend {} {}".format(forward_batch.input_ids, forward_batch.out_cache_loc))
